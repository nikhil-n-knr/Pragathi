...
import RealEstateScene from '../../components/scenes/RealEstateScene';
    ...
    >
      ...
      <div className="fixed top-0 left-0 w-full h-screen pointer-events-none z-0">
        ...
        >
          ...
          <RealEstateScene scrollProgress={scrollProgress} />
        </Canvas>
      </div>
      ...
      <section className="relative h-screen flex flex-col justify-center items-start px-8 md:px-24 z-10 pointer-events-none max-w-4xl">
        <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest mb-3">// Pillar 02 / Asset Holdings</span>
        <h1 className="text-white font-extrabold text-4xl md:text-7xl leading-none uppercase select-text tracking-wider">
          <span className="text-yellow-400 font-sans tracking-[0.1em]">PORTFOLIOS /</span>
        ...
        <div className="border-l border-yellow-400/20 pl-6 md:pl-8 py-2 mt-8 max-w-xl">
          <p className="text-gray-400 font-sans font-light text-xs md:text-sm leading-relaxed select-text">
            Securing high-potential growth corridor plots and premium commercial zones. Our land curation portfolio is anchored in structural feasibility, connectivity indexes, and absolute capital growth.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-10 py-24 px-8 md:px-24 w-full max-w-6xl mx-auto flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Curation Logic</span>
            <h2 className="text-white font-bold text-3xl uppercase tracking-wider mt-2 select-text">Land Intelligence</h2>
            
            <div className="flex flex-col gap-6 mt-8">
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Growth Corridor Mapping</h4>
              ...
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Regulatory/Zoning Clearance</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
                  Complete zoning clearance, titles search verification, environmental compliance, and structural build permission audits.
                </p>
              </div>
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Micro-Infrastructure Ready</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
          ...
          <div>
            <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Investor Framework</span>
            <h2 className="text-white font-bold text-3xl uppercase tracking-wider mt-2 select-text">Investor Logic</h2>
            
            <div className="flex flex-col gap-6 mt-8">
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Liquidity Horizon Modeling</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
                  Analysis matching your capitalization model with appreciation velocity metrics (short vs long-term horizons).
                </p>
              </div>
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Advisory Screen Process</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
                  One-on-one consultation aligning portfolio allocations with verified structural assets.
                </p>
              </div>
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Appreciation Analytics</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
      ...
      <section className="relative z-10 py-24 px-8 md:px-24 w-full max-w-6xl mx-auto flex flex-col items-center">
        <div className="text-center mb-16">
          <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Asset Dossiers</span>
          <h2 className="text-white font-bold text-3xl md:text-5xl uppercase tracking-wider mt-2">
            Plotted Premium Inventory
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <MediaFloat intensity={0.95}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Sector A / Whitefield</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Industrial Zone Hub</h3>
          ...
          <MediaFloat intensity={1.15}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Sector B / Foothills</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Solitaire Ridge</h3>
                <p className="text-gray-400 text-xs mt-2 leading-relaxed font-light font-sans text-center w-full">
          ...
          <MediaFloat intensity={0.85}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Sector C / Corridor</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Nexus Edge Plot</h3>
                <p className="text-gray-400 text-xs mt-2 leading-relaxed font-light font-sans text-center w-full">
      ...
      <section className="relative z-10 py-24 bg-gradient-to-b from-black to-zinc-950 border-t border-yellow-400/10 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Strategic Security</span>
          <h2 className="text-white font-extrabold text-3xl md:text-5xl uppercase tracking-wider mt-2 leading-tight">
            Secure Premium Holdings.
          </h2>
          <p className="text-gray-400 font-sans font-light text-xs md:text-sm mt-6 leading-relaxed max-w-xl mx-auto">
            Our land holdings are vetted with absolute title security and geo-appreciation models. Connect with our dedicated advisory desk to scan live coordinates.
          </p>
          
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            <a 
              href="mailto:land@jagathi.com" 
