    ...
    >
      ...
      <div className="fixed top-0 left-0 w-full h-screen pointer-events-none z-0">
        <Canvas
          ...
          gl={{ antialias: true, alpha: false, stencil: true, depth: true }}
          dpr={[1, 1.5]}
        >
      ...
      <section className="relative h-screen flex flex-col justify-center items-start px-8 md:px-24 z-10 pointer-events-none max-w-4xl">
        <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest mb-3">// Pillar 03 / Interspace Design</span>
        <h1 className="text-white font-extrabold text-4xl md:text-7xl leading-none uppercase select-text tracking-wider">
          <span className="text-yellow-400 font-sans tracking-[0.1em]">SPATIAL SYSTEMS /</span>
      ...
      <section className="relative z-10 py-24 px-8 md:px-24 w-full max-w-6xl mx-auto flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Design Clusters</span>
            <h2 className="text-white font-bold text-3xl uppercase tracking-wider mt-2 select-text">Spatial Planning</h2>
            
            <div className="flex flex-col gap-6 mt-8">
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Layout & Circulation Logic</h4>
              ...
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Execution Scope</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
              ...
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Signature Environments</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
          ...
          <div>
            <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Curation Process</span>
            <h2 className="text-white font-bold text-3xl uppercase tracking-wider mt-2 select-text">Turnkey Workflow</h2>
            
            <div className="flex flex-col gap-6 mt-8">
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Stage 01 / Material Selection</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
                  Choosing stones, fine hardwoods, structural metal finishes, and textiles from our physical materials lab.
                </p>
              </div>
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Stage 02 / In-house Fabrication</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
                  Precision carpentry, cladding prep, and customized light fittings built in our dedicated fabrication centers.
                </p>
              </div>
              <div className="border-l-2 border-yellow-400/30 pl-4 hover:border-yellow-400 transition-colors">
                <h4 className="text-white font-bold text-sm uppercase">Stage 03 / Delivery & Fitting</h4>
                <p className="text-gray-400 font-sans font-light text-xs mt-1 leading-relaxed">
      ...
      <section className="relative z-10 py-24 px-8 md:px-24 w-full max-w-6xl mx-auto flex flex-col items-center">
        <div className="text-center mb-16">
          <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Material Language</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <MediaFloat intensity={1.1}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Texture 01 / Italian Stone</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Dark Veined Marble</h3>
          ...
          <MediaFloat intensity={0.9}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Texture 02 / Hardwood</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Bespoke Smoked Joinery</h3>
                <p className="text-gray-400 text-xs mt-2 leading-relaxed font-light font-sans text-center w-full">
          ...
          <MediaFloat intensity={1.2}>
            <div className="border border-yellow-400/15 bg-zinc-950 p-6 flex flex-col justify-between h-[360px] rounded-sm group">
              ...
              <div className="mt-4 text-center flex flex-col items-center w-full">
                <span className="text-gray-500 font-mono text-[9px] uppercase tracking-widest block text-center w-full">Texture 03 / Upholstery</span>
                <h3 className="text-white font-bold text-lg uppercase mt-1 text-center w-full group-hover:text-yellow-400 transition-colors">Bouclé Lounge Curation</h3>
                <p className="text-gray-400 text-xs mt-2 leading-relaxed font-light font-sans text-center w-full">
      ...
      <section className="relative z-10 py-24 bg-gradient-to-b from-black to-zinc-950 border-t border-yellow-400/10 text-center">
        <div className="max-w-4xl mx-auto px-6">
          <span className="text-yellow-400 font-mono text-xs uppercase tracking-widest">// Custom Spaces</span>
