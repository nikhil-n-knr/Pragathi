...
export default function CivilProcessAccordion() {
  const [activeStep, setActiveStep] = useState(0);

  const steps = [
    {
      num: '01',
      title: 'Zoning & Regulatory Audit',
      desc: 'Screening zoning guidelines, master plan maps, and green zone boundaries to ensure 100% compliant land clearances.'
    },
    {
      num: '02',
      title: 'Link Document Title Search',
      desc: 'Conducting standard 30-year link document search checks to verify title safety and prevent legal disputes.'
    },
    {
      num: '03',
      title: 'Infrastructure Utility Hook',
      desc: 'Securing electricity permits, deep-well water approvals, and wide-tarmac logistics connectivity approvals.'
    }
  ];
      ...
      <div style={{ boxSizing: 'border-box', width: '100%', maxWidth: '1200px', marginLeft: 'auto', marginRight: 'auto' }}>
        <div className="grid gap-16 lg:grid-cols-12 items-start" style={{ boxSizing: 'border-box' }}>
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28 text-center flex flex-col items-center cr-reveal">
            ...
            >
              We conduct thorough regulatory screenings and title verification audits before any plotted land is released to the market.
            </p>
            <a
              href="/contact"
            ...
            >
              Request land audit reports <span>↗</span>
            </a>
          </div>
