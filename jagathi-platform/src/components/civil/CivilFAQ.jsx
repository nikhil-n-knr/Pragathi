...
export default function CivilFAQ() {
  ...
  const faqs = [
    {
      q: 'Are all plotted assets cleared of legal litigation?',
      a: 'Yes. We run thorough 30-year link document checks and environmental clearances before releasing any plotted land to ensure 100% clean, ready-to-register titles.'
    },
    {
      q: 'Do you provide boundary and retaining wall setups?',
      a: 'Absolutely. Every residential or industrial plot listed includes built boundary retaining perimeters, concrete drainage links, and baseline transit-road overlays.'
    },
    {
      q: 'What is the minimum holding scale available?',
      a: 'Residential plots average 12–25 acres, while commercial corridor and industrial smart zone releases scale from 5 up to 180 acres.'
    }
  ];
