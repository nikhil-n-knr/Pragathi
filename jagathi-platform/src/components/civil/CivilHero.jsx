...
export default function CivilHero() {
  return (
    ...
    >
      {/* Background image: Luminous White CAD Masterplan Sketch on Deep Dark Background */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <img
          src="/assets/sketches/dark_sketch_civil_land.png"
          alt="Civil masterplan site CAD sketch"
      ...
      >
        ...
        >
          // Pillar 03 / Land Release &amp; Property Advisory
        </motion.p>
        ...
        >
          Strategic Land &amp; Property Advisory.
        </motion.h1>
        ...
        >
          Vetting, securing, and plotting high-yield growth corridors, industrial smart-zones, and premium plotted inventories with 100% title accuracy.
        </motion.p>
        ...
        >
          ...
          >
            Explore Land Releases <span>↓</span>
          </a>
        </motion.div>
      </div>
    </section>
