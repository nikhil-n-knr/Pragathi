...
export default function ConstructionCollaborations() {
  ...
  const row1Words = ['HEAVY CIVIL INFRASTRUCTURE', 'MASTER CONCRETE CORES', 'CABLE-STAYED VIADUCTS', 'STRUCTURAL LATTICE CORES'];
  const row2Words = ['ESTABLISHED 1989', 'INDUSTRIAL SMART ZONES', 'UNCOMPROMISED PRECISION', 'GRADE M60 CONCRETE'];
