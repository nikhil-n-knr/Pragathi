...
export default function ConstructionProjectIndex() {
  const [projectList, setProjectList] = useState([
    { name: 'Orion Link Bridge', sector: 'Civic Infrastructure', spec: 'Cable-stayed steel arc', year: '2026' },
    { name: 'Silicon Arc Tower', sector: 'Commercial Office', spec: 'Core shear wall core', year: '2025' },
    { name: 'Cogen Industrial Complex', sector: 'Industrial Plant', spec: 'Vibration isolated vaults', year: '2025' },
    { name: 'Jayanagar Hub', sector: 'Urban Commercial', spec: 'Reinforced concrete frame', year: '2024' },
    { name: 'Calicut Estate', sector: 'High-End Residential', spec: 'Architectural structural frame', year: '2024' },
    { name: 'Kochi Marine Terminal', sector: 'Marine Infrastructure', spec: 'Hydrostatic-tested piles', year: '2023' }
  ]);
