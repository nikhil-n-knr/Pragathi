...
export default function ConstructionQuote() {
  const [feedback, setFeedback] = useState({
    quote: 'Jagathi delivered more than structural compliance. They gave our whole organization a clearer way to build for scale.',
    author: 'Infrastructure Partner',
    role: 'Urban Infrastructure Group'
  });
