...
export default function InteriorCollaborations() {
  ...
  const row1Words = ['BESPOKE SPATIAL CURATION', 'TURNKEY INTERIOR SOLUTIONS', 'EXECUTIVE BOARDROOMS', 'LUXURY HOSPITALITY'];
  const row2Words = ['CONCEPT TO FABRICATION', 'ACOUSTIC PANELLING', 'CUSTOM MILLWORK', 'MUSEUM LIGHTING'];
