...
export default function InteriorQuote() {
  const [feedback, setFeedback] = useState({
    quote: 'Jagathi delivered more than design options. They gave our whole organization a clearer way to build luxury for generations.',
    author: 'Curation Consultant',
    role: 'Bespoke Residences Group'
  });
